...
export default defineConfig({
  ...
  routes: [
...

    {
      ...
      routes: [
        { path: '/membership', redirect: '/membership/members' },
        { path: '/membership/members', name: '会员管理', component: '@/pages/Users', access: 'canViewMemberUsers' },
        { path: '/membership/member-levels', name: '会员等级', component: '@/pages/Wallet/MemberLevels', access: 'canViewWalletMemberLevels' },
        { path: '/membership/member-benefits', name: '会员权益', component: '@/pages/Wallet/MemberBenefits', access: 'canViewWalletMemberBenefits' },
        { path: '/membership/recharge-plans', name: '充值方案', component: '@/pages/Wallet/RechargePlans', access: 'canViewWalletRechargePlans' },
        { path: '/membership/member-recharges', name: '会员充值记录', component: '@/pages/Wallet/MemberRecharges', access: 'canViewWalletMemberRecharges' },
      ],
    },
    { path: '/users/members', redirect: '/membership/members', hideInMenu: true },
    { path: '/wallet/member-levels', redirect: '/membership/member-levels', hideInMenu: true },
    { path: '/wallet/member-benefits', redirect: '/membership/member-benefits', hideInMenu: true },
    { path: '/wallet/recharge-plans', redirect: '/membership/recharge-plans', hideInMenu: true },
    { path: '/wallet/member-recharges', redirect: '/membership/member-recharges', hideInMenu: true },
